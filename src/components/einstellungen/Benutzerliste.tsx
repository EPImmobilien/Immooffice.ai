            ...
            >
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <p className="truncate text-[14px] text-text">{person.name}</p>
              ...
              <div className="flex shrink-0 items-center gap-2">
                {selbst ? (
                  ...
                  >
                    <input type="hidden" name="benutzer_id" value={person.id} />
                    <Auswahl
                      name="rolle"
                ...
                {!selbst && (
                  <form action={(daten) => ausfuehren(zugangUmschalten, daten)}>
                    <input type="hidden" name="benutzer_id" value={person.id} />
                    <Button
                      type="submit"
                      variante="leise"
